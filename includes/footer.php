        ...
        <div class="grid grid-4 gap-2">
            <div class="footer-info">
                ...
                <div class="social-links">
                    <a href="#" class="text-primary">FB</a>
                    <a href="#" class="text-primary">IG</a>
                    <a href="#" class="text-primary">YT</a>
                </div>
            </div>
            ...
            <div class="footer-contact">
                <h4 class="mb-1 text-white">Kontakt</h4>
                <p class="fs-sm text-muted mb-1">ul. Przykładowa 1, 42-200 Częstochowa</p>
                <p class="fs-sm text-muted mb-1">Tel: +48 123 456 789</p>
                <p class="fs-sm text-muted">Email: kontakt@mstechpc.pl</p>
            </div>
        </div>

        <div class="footer-bottom">
            <p>&copy; <?php echo date('Y'); ?> MSTechPC Częstochowa. Wszystkie prawa zastrzeżone.</p>
        </div>
    </div>
</footer>
